...
export function isRobuxSessionId(value: string): boolean {
  return SESSION_ID_PATTERN.test(value);
}

export function buildRobuxUsernameModal(targetId: string, defaultUsername = ""): ModalBuilder {
  const customId = buildCustomId("robux", "submit", targetId);
...
export function extractRobuxModalUsername(modal: {
  fields: {
